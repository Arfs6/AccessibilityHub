...
from django.contrib.auth import forms as authForms  # noqa: N812
...
class _CoreUserCreationForm(authForms.UserCreationForm):
    ...
    lastName = forms.CharField(label='Last Name', required=False, help_text='Optional.')
...
class CoreUserCreationForm(forms.ModelForm):
    ...
    class Meta:
        ...
        field_classes: typing.ClassVar = {'username': UsernameField}
